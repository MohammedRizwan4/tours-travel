...
import { useCreateUserMutation, useGetSingleUserQuery, useUpdateUserMutation } from '../../../../store/services/adminUserService';

const AdminSubAddUsers = () => {
...
export default AdminSubAddUsers;
